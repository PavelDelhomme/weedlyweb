...
```
(gdb) break Browser::buildInterface
(gdb) break src/Browser.cpp:343
```
...
- `Browser::buildInterface`
- `Browser::addNewTab`
- `RenderingEngine::displayPage`
