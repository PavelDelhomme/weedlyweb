...
- **Langage :** C++17
- **Structure :** Modulaire avec gestionnaires (FavoritesManager, HTTPManager, etc.)
...
1. ✅ **Système de favorites amélioré** (avec dossiers)
...
7. ✅ **Drag & Drop des favorites**
8. ✅ **Gestion d'history** (base de données)
...
2. **2025-02-14** - Amélioration des gestionnaires de favorites
3. **2025-02-14** - Raccourci duplication d'onglet
4. **2025-02-14** - Système de bookmarks (en cours)
5. **2025-02-07** - Corrections erreurs favorites
6. **2025-02-07** - Intégration base de données
7. **2025-02-05** - Drag & Drop des favorites
8. **2025-02-04** - Ajout de dossiers pour favorites
