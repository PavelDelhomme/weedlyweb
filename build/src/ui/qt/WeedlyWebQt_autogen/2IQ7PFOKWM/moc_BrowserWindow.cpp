...
#include "../../../../../../src/ui/qt/include/qt/BrowserWindow.h"
...
void BrowserWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onUrlChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->onTitleChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->onLoadStarted(); break;
        case 3: _t->onLoadFinished((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 4: _t->onNewTabRequested(); break;
        case 5: _t->onTabCloseRequested((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 6: _t->onTabActivated((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 7: _t->onNavigateBack(); break;
        case 8: _t->onNavigateForward(); break;
        case 9: _t->onRefresh(); break;
        case 10: _t->onGoHome(); break;
        case 11: _t->onUrlBarActivated(); break;
        default: ;
        }
    }
}
