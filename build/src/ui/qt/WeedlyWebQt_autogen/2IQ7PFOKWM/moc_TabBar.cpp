...
#include "../../../../../../src/ui/qt/include/qt/TabBar.h"
...
void TabBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->tabActivated((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TabBar::*)(int )>(_a, &TabBar::tabActivated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TabBar::*)(int )>(_a, &TabBar::tabCloseRequested, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (TabBar::*)()>(_a, &TabBar::newTabRequested, 2))
            return;
    }
}
...
// SIGNAL 0
void TabBar::tabActivated(int _t1)
{
